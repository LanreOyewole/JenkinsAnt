...
#=======================================================================================
# Entry function to deploy JAR and customisation files into an ALSB domain
#=======================================================================================
...
#                elif op.getOperation() == ALSBImportOperation.Operation.Create:
            ...
            if importResult.getFailed().isEmpty() == false:
                ...
                SessionMBean.discardSession(sessionName) ## Lanre 04/08/2016
                raise
